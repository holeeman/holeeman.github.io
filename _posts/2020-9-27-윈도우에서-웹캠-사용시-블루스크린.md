...
![IRQL.png](https://www.dogdrip.net/dvs/d/20/09/27/6f4e04a9b024f670ce8400a6bba048ad.png)

IRQL_NOT_LESS_OR_EQUAL 블루스크린 [1]
...
![캡처2.PNG](https://www.dogdrip.net/dvs/d/20/09/27/7358bed1b86c16e00087444dc0f2b889.PNG)
...
해당 글의 내용에 따르면 Windows 10 1909와 2004 버전의 최신 기능 업데이트 이후 몇몇의 웹캠 모델들이 블루스크린을 일으켰다는 것이다 [2].

 

윈도우의 기능 업데이트는 일년에 두번정도 반년주기 채널 (Semi-Annual Channel) 에서 공개 되는데,

현재 가장 최신 버전의 기능 업데이트는 5월 27일에 공개되고 2020년 9월 8일에 마지막으로 수정된 2004 버전이며 [3],
...
Sunsoft IT 회사의 웹캠 드라이버 또는 비슷한 종류의 드라이버가 문제를 일으키는 것으로 확인됐다 [2].
